				...
				if (rs2.next()) {
					...
					if (rs3.next()) {
						...
						try {
							...
							FlashCardController1 quizAlterarQuestao = loader.getController();

							quizAlterarQuestao.setIdJogo(idFlashCard);
							quizAlterarQuestao.setUserAluno(nomeAluno);

							
							quizAlterarQuestao.getLblNomeDoJogo().setText(nomeFlashCard);
							quizAlterarQuestao.getLblPergunta().setText(frase);
							quizAlterarQuestao.setCondicao(condicao);
							quizAlterarQuestao.setExplicacao(explicacao);
							quizAlterarQuestao.getLblCard().setText("Card 1/" + Integer.toString(totalQuestoes));
