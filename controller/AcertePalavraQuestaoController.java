...
public class AcertePalavraQuestaoController {
	...
	public void adcionarQuestao(String dica, String palavra, CriarAcerteAPalavra tela, String id_jogo) { // TROCAR TELA QUIZ PELA TELA DE ADCIONAR QUESTAO NO ACERTE PALAVRA
		new AcertePalavraQuestaoBO().adcionarQuestao(dica, palavra, id_jogo, tela);
	}
	
	
	public void alterarQuestao(int id , String dica, String palavra, TelaQuizAlterar tela) {// TROCAR TELA QUIZ PELA TELA DE ADCIONAR QUESTAO NO ACERTE PALAVRA
		
		new AcertePalavraQuestaoBO().alterarQuestao(id, dica, palavra, tela);
	...
	public void excluirQuestao(int id, TelaQuizAlterar tela) {
		new AcertePalavraQuestaoBO().excluirQuestao(id, tela);
	}
